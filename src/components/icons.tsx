/**
 * Shared inline SVG primitives for the Projects section.
 *
 * Tiny, single-purpose icons extracted from the old monolithic component so
 * each project sub-component imports only what it needs. All stroke-based and
 * sized 24x24 so they render identically wherever used.
 */
